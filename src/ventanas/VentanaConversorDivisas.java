...
//	}
	...
	private void initialize() {
		...
		frmConversorDeDivisas.setTitle("Conversor de Monedas");
		...
		entradaDivisaOrigen.setToolTipText("Seleccione la Moneda a convertir\n");
		...
		labelSalida = new JLabel("Bienvenido a mi Conversor de Monedas");
		...
		JLabel lblChallengeOne = new JLabel("Challenge  Back-end -Erick Brandon Gallegos Ibarra");
